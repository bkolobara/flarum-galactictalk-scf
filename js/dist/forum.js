...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add("scf-vote-count", function () {
  flarum_models_Post__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.votes = flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.attribute("votes");
  flarum_models_Post__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.likes = flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.hasMany("likes");
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, "footerItems", function (items) {
    ...
    if (votes) {
      items.add("scf-voted", m("div", {
        className: "Post-votes"
      }, flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_5___default()("fas fa-poll"), m("span", null, "Eligible votes: ", votes)));
    }
  });
});
